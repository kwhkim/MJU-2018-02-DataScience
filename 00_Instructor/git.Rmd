...
* "In a **depolyed** repository"? 

* "it will not put it in your current checked out code (**working area**)."

* 

----

* history에 나오는 `HEAD -> refs/heads/master`는 뭔가?

* history에 나오는 `origin/master`와 `origin/HEAD`는 뭔가?
    - `origin/master`는 `origin` remote repository에 `master` 브랜치인듯...
    - `HEAD`는 뭐라고? 

----
### [How to merge specific files from a branch](https://stackoverflow.com/questions/18115411/how-to-merge-specific-files-from-git-branches)
