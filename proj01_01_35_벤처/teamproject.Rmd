...
2) summary 함수를 이용한 분석
```{r}
#자산, 부채, 자본의 outlier를 boxplot으로 확인
...
```
 ...
 결론적으로 석사 이상 창업자에게서는 기업 자산의 차이가 현저하게 나타나지 않지만, 대졸 및 전문과정에 있어서는 확연한 차이를 보이며, 공학, 자연과학, 경영 전공 순서의 창업자들의 기업자산이 더 높은 것으로 알 수 있다.
