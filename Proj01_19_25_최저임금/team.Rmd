...
```{r message=FALSE, warning=FALSE}
#데이터 불러들이기
price <- read_xlsx("price inf.xlsx")
rent <- read_xlsx("rent inf.xlsx") 
wage <- read_xlsx("wage_inf.xlsx")
gdp <- read_xlsx("gdp deflator inf.xlsx")
...
```{r}
rent_area <- read_xlsx("rent_area.xlsx")
...
![강남지역공실률](gangnam1.jpg)

![영등포신촌지역공실률](hangdae1.jpg)
